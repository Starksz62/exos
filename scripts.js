...
// CODE ICI
// let array = [5,4,43,4,8,596,52,4]
// const parcoursArray = (tableau) => {
//     return tableau[0]
// }
// console.log (parcoursArray(array))
//----------------------------------------------------------------------------------------------//
// EXERCICE 3
...
// CODE ICI
// let newArray = ['poisson', 'chat','chien','aigle','baleine','guépard']
// let arraypop = []; 
// const removeArray = (tableau) => {
     
//     arraypop = tableau.pop()
// }
...
// CODE ICI
// let tableauCalcul = [44,86,51,56,2,7,6,1];
// let resultat  = 0;

// const calculatorArray = (tableau) => {
//     for (let i =0 ; i < tableau.length; i++) {
//          resultat += tableau[i]
//     }
// }
// calculatorArray(tableauCalcul)
...
// let messageAccueil= 'Hello';

// const inversion = (text) => {
...
// }
// console.log(inversion(messageAccueil))
...
// CODE ICI
// let myArray = [4,485,5,787,54,4564,684,64];
// const maxNumber = (tableau) => {
...
// })
// CODE ICI
// const stringWithoutVoyelles = (mot) => {
//     let voyelles = 'aeiou';
//     let newWord = '';
...
//     return newWord;
// }
// console.log(stringWithoutVoyelles('Romain'))
//----------------------------------------------------------------------------------------------//
...
// let myArray = [5,6,8,1,2,6,7,9,10,4,3];
// const trieurNumber = (tableau) => {
//     return tableau.sort((a,b) => a-b);
// };
// console.log(trieurNumber(myArray));
...
// const rotationFunction = (mot) => {
//     const newArray = [];
//     for (let i = 0 ; i< mot.length ; i++){
//         const motChange = mot.substring(i) + mot.substring(0,i);
//         newArray.push(motChange);
//     }
//     return newArray
// }
// console.log(rotationFunction(message));
...
// const Arrayaccum = (nbre) => {
//     const additionTableau = nbre.map((element) => {
//         return element + 1
//     })
//     return additionTableau;
// }
// console.log(Arrayaccum(number));
...
// CODE ICI
// let personne = ["Alice", "Bob", "Charlie", "David", "Emma"];
// const calculLength = (nom) => {
//     const longueurTableau = nom.map((element) =>{
//         return element.length
//     })
//     return longueurTableau
// }
// console.log(calculLength(personne));
//----------------------------------------------------------------------------------------------//
...
// const monTableauPremiereLettre = personne.map((element) => {
//     return element.charAt(0)
// })
...
// CODE ICI
// const monTableauDernièreLettre = personne.map((element) => {
//     return element.charAt(element.length-1)
// })
// console.log(monTableauDernièreLettre);
//----------------------------------------------------------------------------------------------//

// EXERCICE 15

// Crée une fonction qui prend en paramètre un tableau de string et qui doit renvoyer tous les string qui ont une longueur de 5 caractères ou plus.
...
// CODE ICI
// let newMember = ["Alice", "Bob", "Charlie", "David", "Emma"];
// const stringSuperieurACinq = (mot) => {
//     const motsFiltres = mot.filter(mots => mots.length >= 5)

//     return motsFiltres

// }

// console.log(stringSuperieurACinq(newMember));
...
// let number = [1,2,3,4,5,6,8,7,9,54];
// const somme = number.reduce((accumulateur, element) => {
//       return accumulateur + element
//     }, 0);
//     console.log(somme);
...
// CODE ICI
    ...
    // const concatTableau = (tab1, tab2) => {
    //     return tab1.concat(tab2)
    // }
    // console.log(concatTableau(monTableau1,monTableau2))
//----------------------------------------------------------------------------------------------//
...
// CODE ICI
// const animal =["Poulet", "Chat", "Chien", "Cheval"] 
// const animalWithE = (animal) => {
//      let filter = animal.filter((element) => element.includes('e'));
//      console.log(filter)
// }
// animalWithE(animal);
//----------------------------------------------------------------------------------------------//
...
// const number = [ 2, 9, 6, 5, 6];
// const numberPair = (nbre) => {
//     let pairs = [];
...
// CODE ICI
// let findShort = "The quick brown fox jumps over the lazy dog"


// const wordsShort = (phrase) => {
//     let split =  phrase.split(' ');
//     let motLePlusCourt = split[0].length;
//      for (let i = 0 ; i < split.length ; i++) {
//         const longueurMots = split[i].length;
//         if (motLePlusCourt > longueurMots) {
//             motLePlusCourt = longueurMots
//         }
...
// }
// console.log(wordsShort(findShort))
...
const anagram1 = 'romain';
const anagram2 = 'marion';


const comparator = (mot1, mot2) => {

    const compMot1 = mot1.split('').sort().join('');
    const compMot2 = mot2.split('').sort().join('');

    return compMot1 === compMot2
}
console.log(comparator(anagram1,anagram2))
...
const tri = (animaux) => {
    for (let i=0; i < animals.length; i++) {
       animals[i].type === 'Domestic' ? domestique.push(animals[i].name) : sauvage.push(animals[i].name);

}
domestique.sort();
sauvage.sort().reverse();
animaux.push(domestique, sauvage);
return animaux
}
console.log(tri(animaux))
